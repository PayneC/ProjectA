    ...
    public class DGTweeningDOTweenVisualManagerWrap 
    {
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					DG.Tweening.DOTweenVisualManager __cl_gen_ret = new DG.Tweening.DOTweenVisualManager();
        ...
        static int _g_get_preset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.preset);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_onEnableBehaviour(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.onEnableBehaviour);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_onDisableBehaviour(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.onDisableBehaviour);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_preset(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                DG.Tweening.Core.VisualManagerPreset __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.preset = __cl_gen_value;
        ...
        static int _s_set_onEnableBehaviour(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                DG.Tweening.Core.OnEnableBehaviour __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.onEnableBehaviour = __cl_gen_value;
        ...
        static int _s_set_onDisableBehaviour(RealStatePtr L)
        {
		    try {
                ...
                DG.Tweening.DOTweenVisualManager __cl_gen_to_be_invoked = (DG.Tweening.DOTweenVisualManager)translator.FastGetCSObj(L, 1);
                DG.Tweening.Core.OnDisableBehaviour __cl_gen_value;translator.Get(L, 2, out __cl_gen_value);
				__cl_gen_to_be_invoked.onDisableBehaviour = __cl_gen_value;
