...
local _index = {
    10000001, 10000002, 10000003, 10100101, 10100102, 10100103, 10100104, 11101001, 11101002, 11101003, 11101004, 11102001, 11102002, 11102003, 11102011, 11102012, 11102013, 11102021, 11102022, 11102023, 11102031, 11102032, 11102033, 11103001, 11103002, 11103003, 
}
