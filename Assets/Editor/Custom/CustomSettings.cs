...
public static class CustomSettings
{
    ...
    public static DelegateType[] customDelegateList =
    {
        ...
        _DT(typeof(UnityEngine.Events.UnityAction<GameObject>)).SetAbrName("UnityAction_GameObject"),
    ...
    {                
        ...
        _GT(typeof(AssetEntity)),
        _GT(typeof(AssetUtil)),
        _GT(typeof(GameObjectUtil)),
        _GT(typeof(InputUtil)),
        _GT(typeof(EAssetType)),
